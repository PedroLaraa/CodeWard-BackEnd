      ...
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <div className="bg-gray-800 p-6 rounded-lg shadow-lg space-y-4">
          <label className="block">
            <span className="text-sm text-gray-300">Envie seu arquivo <code>requirements.txt</code></span>
            <input
              type="file"
              accept=".txt"
        ...
        {results.length > 0 && (
          <div className="space-y-6">
            ...
            {results.map((res, i) => (
              <div
                key={i}
                className="border border-purple-500 rounded p-4 bg-gray-800 shadow-md"
              >
                ...
                {res.vulnerabilities.length > 0 ? (
                  <ul className="mt-2 space-y-2">
                    {res.vulnerabilities.map((vuln, idx) => (
                      <li key={idx} className="bg-gray-700 p-4 rounded space-y-2 border-l-4 border-red-600">
                        <div>
